...
with gr.Blocks(css=css) as ui:
    ...
    gr.HTML(value="<p>Below is an example response both from Auditor as well as Critic side :- </p>")
    with gr.Row():
        with gr.Column(scale=1, min_width=500):
    ...
    gr.HTML(value="<p>There is an additional stage called Ranking/Discrimination. As we know, the role of a critic is to filter out the correct results from a myriad of false positives. To ascertain what is the best, we consider three distinct factors: correctness, severity and profitability, because although some false positives may be correct, they might possess a diminished level of severity or may not be profitable for attackers. The role of the Ranker is to rank all vulnerabilities descendingly based on these scores and choose the top-k vulnerabilities from the list as the output.</p>")
    ...
    with gr.Row():
        with gr.Column(scale=1, min_width=333):
            gr.Image("src/images/developer.png", width=200, height=200, show_download_button=False, show_label=False, scale=1)
        ...
        with gr.Column(scale=1, min_width=333):
            gr.Image("src/images/author.png", width=200, height=200, show_download_button=False, show_label=False, scale=1)
        ...
        with gr.Column(scale=1, min_width=333):
            gr.Image("src/images/professor.png", width=200, height=200, show_download_button=False, show_label=False, scale=1)
